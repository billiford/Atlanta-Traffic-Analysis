/*
 * 98% of this code is credited to user Zverik.
 * L.TileLayer.Invert is a regular tilelayer with invert makeover.
 */

L.TileLayer.Invert = L.TileLayer.extend({
	options: {
		enableCanvas: true
	},
...
L.tileLayer.invert = function (url, options) {
	return new L.TileLayer.Invert(url, options);
};